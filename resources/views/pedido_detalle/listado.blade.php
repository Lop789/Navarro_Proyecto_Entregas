...
@section('titulo', 'Listado de detalle de pedidos')
...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 min-h-screen">
  <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
      <div class="p-4">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Detalle de pedidos</h2>
      </div>
          ...
          <tbody>
            @foreach ($detalles as $detalle)
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3">Pedido #{{ $detalle->pedido_id }} - {{ optional(optional($detalle->pedido)->cliente)->nombres }}</td>
